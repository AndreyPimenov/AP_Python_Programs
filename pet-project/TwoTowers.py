...
def map_function():
    ...
    print("в этой главе тебе нужно подготовиться и отбить вторжение....")
    print("навигация по миру осуществляется:")
    print("{:^52}".format("         gN           "))
    print("{:^52}".format("         / \          "))
    print("{:^52}".format("          |           "))
    print("{:^39}".format("gW  < - - | - - >   gE"))
    print("{:^52}".format('          |          '))
    print("{:^52}".format('         \ /         '))
    print("{:^52}".format('          gS         '))
    print("{:^52}".format("data center aligned"))
    print("{:<52}".format("Карта мира (вид сверху):"))
    print("{:^52}".format(" ___________________________________________________"))
    print("{:^52}".format("|  A2   |    A1    | ~ ~ ~  |    B1    |    B2     |"))
    print("{:<72}".format("| .  .  |__________|  ~ ~   |__________|           |"))
    print("{:^72}".format("|       /          | river  |           \          |"))
    print("{:^52}".format("|      /           | ~ ~ ~  |            \         |"))
    print("{:^52}".format("|_____/            |  ~ ~   |             \________|"))
    print("{:^52}".format("| A3  |            |________|             | B3     |"))
    print("{:^52}".format("|     |     A      | Bridge |   B         |        |"))
    print("{:^52}".format("|     |   TOWER    |________| TOWER       |        |"))
    print("{:^52}".format("|_____|            |        |             |________|"))
    print("{:^52}".format("| A4   \           |  ~ ~   |            / B4      |"))
    print("{:^52}".format("|       \          | river  |           /          |"))
    print("{:^52}".format("|        \_________|  ~ ~   |__________/           |"))
    print("{:^52}".format("|        | A5      | ~ ~ ~  | B5       |           |"))
    print("{:^52}".format("|________|_________|________|__________|___________|"))
...
print(main_hero.name, "ты весь мокрый и стоишь на широком мосту между двух огромных башен. Что ты будешь делать? (для подсказки набери H)")
